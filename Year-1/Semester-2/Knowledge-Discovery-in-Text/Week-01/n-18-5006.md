...
* **Tokenization and POS Tagging**:
  ...
  * *Arabic*: Uses the `Farasa` segmenter for tokenization, word segmentation (necessary for separating conjunctions and clitics to prevent vocabulary explosion), and POS tagging[cite: 80, 81, 82, 111].
...
* **MUSE Embeddings**: Uses Facebook's supervised MUSE model to project Arabic and English embeddings into a joint space based on TED talks corpora. This was chosen for the final system as it yielded the best overall performance[cite: 125, 131, 153].
